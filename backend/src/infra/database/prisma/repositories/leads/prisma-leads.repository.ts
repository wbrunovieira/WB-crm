  ...
  async findById(id: string, requesterId: string, requesterRole: string): Promise<LeadDetail | null> {
    ...
    return {
      ...
      leadContacts: row.leadContacts.map((lc) => ({
        ...
        whatsappVerified: lc.whatsappVerified,
        whatsappVerifiedAt: lc.whatsappVerifiedAt,
        whatsappVerifiedNumber: lc.whatsappVerifiedNumber,
        emailVerified: lc.emailVerified,
        emailVerifiedAt: lc.emailVerifiedAt,
        emailVerificationStatus: lc.emailVerificationStatus,
        emailVerificationReason: lc.emailVerificationReason,
