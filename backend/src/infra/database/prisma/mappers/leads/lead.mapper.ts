...
export class LeadMapper {
    ...
    return Lead.create(
      {
        ...
        revenueRange: raw.revenueRange ?? undefined,
        segment: raw.segment ?? undefined,
        legalNature: raw.legalNature ?? undefined,
        branchType: raw.branchType ?? undefined,
        simplesNacional: raw.simplesNacional ?? undefined,
        isMei: raw.isMei ?? undefined,
  ...
  static toPrisma(lead: Lead): Omit<PrismaLead, never> {
    return {
      ...
      agentSummary: lead.agentSummary ?? null,
      agentUpdatedFields: lead.agentUpdatedFields ?? null,
      agentResearchAt: lead.agentResearchAt instanceof Date ? lead.agentResearchAt : lead.agentResearchAt ? new Date(lead.agentResearchAt as string) : null,
