...
export abstract class WhatsAppEntityRepository {
  ...
  abstract updateLeadContactVerification(leadContactId: string, data: WhatsAppVerificationData): Promise<boolean>;
  ...
  abstract updateLeadContactNumber(leadContactId: string, whatsapp: string): Promise<boolean>;
}
