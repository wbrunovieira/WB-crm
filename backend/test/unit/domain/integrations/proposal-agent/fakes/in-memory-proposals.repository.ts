import { ProposalsRepository, type ProposalFilters } from "@/domain/proposals/application/repositories/proposals.repository";
import type { Proposal } from "@/domain/proposals/enterprise/entities/proposal";
