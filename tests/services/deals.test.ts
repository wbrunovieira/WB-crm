  ...
  describe("getDealSummary", () => {
    it("should return complete deal summary", () => {
      const deal = createMockDeal({
        ...
        products: [
          { id: "dp-1", dealId: "deal-123", productId: "p1", quantity: 1, unitPrice: 1000, discount: 0, totalValue: 1000, description: null, deliveryTime: null, status: 'active', removedAt: null, createdAt: new Date(), updatedAt: new Date() },
        ],
        activities: [
