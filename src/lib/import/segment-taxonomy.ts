...
export const CANONICAL_SEGMENTS = [
  ...
  // Novos — mais.ods (moda/joalharia/hotel)
...
const ALIASES: Record<string, CanonicalSegment> = {
  ...
  // ── Inglês — mais.ods (moda/joalharia/hotel) ─────────────────────────────────
  "clothing":                        "Vestuário e Moda",
  "apparel & fashion":               "Vestuário e Moda",
  "apparel and fashion":             "Vestuário e Moda",
  "retail apparel and fashion":      "Vestuário e Moda",
  "design & fashion":                "Vestuário e Moda",
  "design and fashion":              "Vestuário e Moda",
  "sustainable fashion":             "Vestuário e Moda",
  "lingerie & underwear store":      "Vestuário e Moda",
  "clothing manufacturing":          "Vestuário e Moda",
  "cosmetics":                       "Beleza e Estética",
  "hair salon":                      "Beleza e Estética",
  "jewelry":                         "Joalharia e Relógios",
  "jewellery":                       "Joalharia e Relógios",
  "jewelry/watches":                 "Joalharia e Relógios",
  "jewellery/watches":               "Joalharia e Relógios",
  "luxury goods and jewelry":        "Joalharia e Relógios",
  "retail luxury goods and jewelry": "Joalharia e Relógios",
  "hotel":                           "Hotel e Hospedagem",
  "shoes":                           "Calçados",
  "footwear":                        "Calçados",
  "footwear store":                  "Calçados",
  "accessories":                     "Acessórios e Bolsas",
  "bags/luggage":                    "Acessórios e Bolsas",
  "bags and luggage":                "Acessórios e Bolsas",
  "baby goods/kids goods":           "Artigos Infantis",
  "toy store":                       "Artigos Infantis",
  "art gallery":                     "Arte e Criação",
  "arts & crafts store":             "Arte e Criação",
  "visual arts":                     "Arte e Criação",
  "modeling agency":                 "Arte e Criação",
  "comic bookstore":                 "Arte e Criação",
  "advertising agency":              "Agência de Publicidade",
  "game development studio":         "Tecnologia e Software",
  "games":                           "Tecnologia e Software",
  "eletronics":                      "Celulares e Tecnologia",
  "electronics":                     "Celulares e Tecnologia",
  "college & university":            "Educação",
  "insurance company":               "Seguros e Finanças",
  "motor vehicle manufacturing":     "Indústria e Manufatura",
  "industrial company":              "Indústria e Manufatura",
  "packaging":                       "Indústria e Manufatura",
  "herbal products":                 "Produtos Naturais",
  "sporting goods":                  "Artigos Esportivos",
  "supermarket":                     "Supermercado",
  "restaurants":                     "Alimentação e Gastronomia",
  "restaurant":                      "Alimentação e Gastronomia",
  "food and beverages":              "Alimentação e Gastronomia",
  "food and beverage services":      "Alimentação e Gastronomia",
  "food delivery service":           "Alimentação e Gastronomia",
  "pastry shop":                     "Confeitaria e Doçaria",
  "sunglasses & eyewear store":      "Saúde e Clínicas",
  "safety & first aid service":      "Saúde e Clínicas",
  "home decor":                      "Móveis e Decoração",
  "design products":                 "Móveis e Decoração",
  "design services":                 "Gráfica e Comunicação Visual",
  "flower":                          "Varejo Geral",
  "household supplies":              "Utilidades Domésticas",
  "tourism":                         "Turismo e Viagens",
  "travel tours":                    "Turismo e Viagens",
  "concept store":                   "Varejo Geral",
  "retail company":                  "Varejo Geral",
  "retail company ":                 "Varejo Geral",
  "shopping service":                "Varejo Geral",
  "product/service":                 "Varejo Geral",
  "commercial equipment":            "Varejo Geral",
  "enterprise":                      "Varejo Geral",
  "sacoor brothers":                 "Vestuário e Moda",
  "clothes & accessories":           "Acessórios e Bolsas",
  "clothes and accessories":         "Acessórios e Bolsas",
  "consulting agency":               "Varejo Geral",
