  ...
  return (
    <div className="p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Inteligência de mercado por setor para prospecção
              </p>
            </div>
          </div>
        </Link>
        ...
        {/* Gmail Templates Card */}
        <Link
          href="/admin/gmail-templates"
          className="group block rounded-lg border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-all hover:border-blue-500"
        >
          <div className="flex items-center gap-4">
            <div className="rounded-lg bg-blue-100 p-3 group-hover:bg-blue-600 transition-colors">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="rounded-lg bg-green-100 p-3 group-hover:bg-[#25D366] transition-colors">
              <MessageSquare className="h-6 w-6 text-[#25D366] group-hover:text-white" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 group-hover:text-primary">
                Templates WhatsApp
