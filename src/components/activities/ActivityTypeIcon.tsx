...
export default function ActivityTypeIcon({ type, className = "h-5 w-5" }: Props) {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    whatsapp: (
      <svg className={`${base} text-green-500`} fill="currentColor" viewBox="0 0 24 24">
    ...
    instagram_dm: (
      <svg className={`${base} text-pink-600`} fill="currentColor" viewBox="0 0 24 24">
