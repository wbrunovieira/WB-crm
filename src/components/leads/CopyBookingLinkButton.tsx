...
/**
 * Gera (via /scheduling/links) e copia o link de auto-agendamento do lead.
 * Se ainda não houver tipo de reunião, o backend cria um padrão automaticamente.
 */
export function CopyBookingLinkButton({ leadId }: { leadId: string }) {
  ...
  return (
    <button
      ...
      onClick={generate}
      disabled={loading}
      title="Gerar e copiar o link de agendamento deste lead"
