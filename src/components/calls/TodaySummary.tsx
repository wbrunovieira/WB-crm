...
export function TodaySummary({ dailyStats, todayDate }: Props) {
  ...
  const items = [
    ...
    { icon: PhoneMissed, label: "Não atendeu",  value: stats.noAnswer + stats.busy, prev: prevStats ? prevStats.noAnswer + prevStats.busy : undefined, color: "text-red-400", border: "#dc2626", bg: "rgba(239,68,68,0.1)" },
